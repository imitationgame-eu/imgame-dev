<?php
// stratification of "has lived in uni accommodation"
// 1 == "University residence" in Step4 table
// label and group output:
// '0' : not uni accomm
// '1' : uni accomm
// csv output:
// 1 = uni accom
...
include_once $root_path.'/domainSpecific/mySqlObject.php';        
  ...
  function getS1attributes($iUid, $npUid, $pUid) {
    ...
    if ($igrtSqli->affected_rows > 0) {
      ...
      $ia = "0";
      if (($aRow->yr1dwelling == 'University residence') ||
          ($aRow->yr2dwelling == 'University residence') ||
          ($aRow->yr3dwelling == 'University residence') ||
          ($aRow->yr4dwelling == 'University residence') ) {
        $ia = "1";
      }
    }
  ...
  function getS2attributes($actualJNo) {
    ...
    if ($igrtSqli->affected_rows > 0) {
      ...
      if (($eRow->yr1dwelling == 'University residence') ||
          ($eRow->yr2dwelling == 'University residence') ||
          ($eRow->yr3dwelling == 'University residence') ||
          ($eRow->yr4dwelling == 'University residence') ) {
    ...
    if ($igrtSqli->affected_rows > 0) {
      ...
      if (($oRow->yr1dwelling == 'University residence') ||
          ($oRow->yr2dwelling == 'University residence') ||
          ($oRow->yr3dwelling == 'University residence') ||
          ($oRow->yr4dwelling == 'University residence') ) {
...
if ($igrtSqli->affected_rows > 0) {
  while ($qsRow = $qsResult->fetch_object()) {
    ...
    $s2 = getS2attributes($actualJNo);            // returns list of 2 different attributes RespNo for each jType
    $s4 = getS4attributes($actualJNo);            // returns list of 2 different attributes s4jNo for each jType
    $eS2array = array(
      's20'=>$s2['eS20'],
      's21'=>$s2['eS21']
    );
  ...
  echo 'for columns A to E,1=has lived in uni dwelling,2=not lived in uni dwelling<br/>';
