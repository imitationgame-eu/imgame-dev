<?php
// stratification of "study length"
...
if ($igrtSqli->affected_rows > 0) {
  ...
  echo 'for columns A to E,1=is first year,2=greater than 1 year<br/>';
