  ...
  if ($uidResult) {
    ...
    while ($eidRow = $uidResult->fetch_object()) {
      ...
      $html .= "<tr>";
        ...
        $html .= "<td><p>$goodO complete $oddS1Label judges out of $oddS4JudgeCount</p>".$htmlBuilder->makeButton($buttonId, "monitor", "button")."</td>";        
        }
        else {
          $html.= "<td>no data</td>";        
        }
        if ($evenS4JudgeCount > 0) {
          ...
          $html .= "<td><p>$goodE complete $evenS1Label judges out of $evenS4JudgeCount</p>".$htmlBuilder->makeButton($buttonId, "monitor", "button")."</td>";
        }
        else {
          $html.= "<td>no data</td>";
        }
