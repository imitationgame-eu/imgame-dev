...
// -----------------------------------------------------------------------------
// 
// web service to support AJAX calls generated from a generic TBT step4
...
require_once($root_path.'/helpers/step4/class.genStep4TBTController.php');
//
//
$permissions = $_GET['permissions'];
  ...
  function processMessage() {
    ...
    $s4Controller = new genTBTstep4Controller($exptId); 
    $msg = '';
    switch ($messageType) {
      //
