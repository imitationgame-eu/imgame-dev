...
//  jType = $('#hiddenJType').text();
  ...
  $.ajax({
    type: 'GET',
    url: '/webServices/step4/getLEMonitorDetail.php',
    data: paramSet,
    dataType: 'json',
...
var transcriptsViewModel = function(data, target) {
  ...
  this.respNo1 = ko.observable();
  this.s3respNo1 = ko.observable();
  this.s3rnLabel1 = ko.observable();
  this.respNo2 = ko.observable();
  this.s3respNo2 = ko.observable();
  this.s3rnLabel2 = ko.observable();
  this.rated = ko.observable();
  this.correct = ko.observable();
  this.confidence = ko.observable();
  this.reason = ko.observable();
  this.transcriptVisible = ko.observable(true);
