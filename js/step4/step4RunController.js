...
function sendAction(messageType, content) {
  ...
  $.ajax({
    type: 'GET',
    url: '/webServices/step4/step4RunController.php',
    data: paramSet,
    dataType: 'text',
...
function processData(data) {
  ...
  switch (messageType) {
    ...
    case "step4Transcript":
      ...
      respNo = parseInt(xmlDoc.getElementsByTagName("respNo")[0].firstChild.nodeValue);
      qNo = parseInt(xmlDoc.getElementsByTagName("qNo")[0].firstChild.nodeValue);
      s3respNo = parseInt(xmlDoc.getElementsByTagName("s3respNo")[0].firstChild.nodeValue);
    ...
    case 'discarded' :
      ...
      contentArray[1] = 'discardedResponse';
