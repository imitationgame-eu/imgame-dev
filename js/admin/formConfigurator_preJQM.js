...
var pagesViewModel = function (data, target, parent) {
  ...
  this.canDelPage = ko.computed(function() { return _this.pageNo() ==='0' ? false : true ;});
...
var questionsViewModel = function(data, target, parent) {
  ...
  this.canDelQ = ko.computed(function() { return _this.qNo() === '0' ? false : true;});
  ...
  this.multiOptions = ko.computed(function() {
    if ( (_this.qType() === 'selector') || (_this.qType() === 'radiobutton') || (_this.qType() === 'slider') ) { return true; } else { return false;} 
  });
