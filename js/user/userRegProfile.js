...
function showProfile(profileHtml) {
...
$(document).ready(function() {
  ...
  var paramSet = {};
  paramSet['uid'] = uid;
  paramSet['permissions'] = 255;  // override own user permissions as non-admin users can get own profile
  $.ajax({
    type: 'GET',
    url: '/webServices/user/getProfileForm.php',
    data: paramSet,
    dataType: 'text',
    success: function(rdata) { showProfile(rdata); }
  });
});
